...
VADs use the seq2seq architecture as the base (specifically comprised of a RNN with GRUs for both the encoder and decoder), with variable-length queries $x = \{x_1, x_2, ..., x_n\}$, and $y = \{y_1, y_2, ..., y_n\}$ representing the input and output responses respectively. 
