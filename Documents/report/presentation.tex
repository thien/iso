...
\usepackage{ulem} % for strike throughs
...
\end{figure}
% lots of contention about how generic the responses are and it can most likely be attributed to the lack of variation in the responses.
\end{frame}
